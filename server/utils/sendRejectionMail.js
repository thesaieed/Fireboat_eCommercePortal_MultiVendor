...
module.exports.sendRejectionMail = async (name, email, rejectionReason) => {
  const subject = "Your Registration has been Rejected with AlSaleels!";
  const body = `<div
  class="container"
...
>
  ...
  <p style="margin-bottom: 30px;">We are sorry to inform you that your Registration with AlSaleels has been Rejected.  </p>
